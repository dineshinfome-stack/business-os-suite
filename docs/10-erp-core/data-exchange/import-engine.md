---
title: "Import Engine"
summary: "Ingests external data (files, APIs) into governed business entities with validation, mapping, and reconciliation."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "data-exchange"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "data-exchange"
...
The **Import Engine** is a reusable platform capability in the **Data Exchange** category of BusinessOS ERP Core. Ingests external data (files, APIs) into governed business entities with validation, mapping, and reconciliation.
