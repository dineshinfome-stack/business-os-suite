...
summary: "Manages business document lifecycles (create, revise, version, supersede, archive) independent of any specific module."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "document"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "document"
...
The **Document Engine** is a reusable platform capability in the **Document** category of BusinessOS ERP Core. Manages business document lifecycles (create, revise, version, supersede, archive) independent of any specific module.
