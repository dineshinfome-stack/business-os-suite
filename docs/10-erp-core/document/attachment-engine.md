...
summary: "Attaches files and references to business records with metadata, classification, and retention policies."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Attachment Engine** is a reusable platform capability in the **Document** category of BusinessOS ERP Core. Attaches files and references to business records with metadata, classification, and retention policies.
