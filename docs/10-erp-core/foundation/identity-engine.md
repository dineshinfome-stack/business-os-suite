...
summary: "Authenticates principals (human users, service accounts, AI agents) and issues verifiable identity claims."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Identity Engine** is a reusable platform capability in the **Foundation** category of BusinessOS ERP Core. Authenticates principals (human users, service accounts, AI agents) and issues verifiable identity claims.
