...
summary: "Evaluates, at request time, whether a given principal may perform a given action on a given resource in a given context."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "foundation"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "foundation"
...
The **Authorization Engine** is a reusable platform capability in the **Foundation** category of BusinessOS ERP Core. Evaluates, at request time, whether a given principal may perform a given action on a given resource in a given context.
...
- No ERP Core dependencies (foundational)
