...
summary: "Exposes AI-as-principal capabilities (conversation, tool-calling, retrieval) under Authorization and Audit."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **AI Copilot Engine** is a reusable platform capability in the **AI** category of BusinessOS ERP Core. Exposes AI-as-principal capabilities (conversation, tool-calling, retrieval) under Authorization and Audit.
