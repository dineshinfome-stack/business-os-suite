---
title: "Event Engine"
summary: "Publishes, routes, and delivers domain events reliably with ordering and delivery guarantees appropriate to each channel."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Event Engine** is a reusable platform capability in the **Integration** category of BusinessOS ERP Core. Publishes, routes, and delivers domain events reliably with ordering and delivery guarantees appropriate to each channel.
