...
summary: "Orchestrates internal and external integrations with connectors, transformation, retry, and idempotency guarantees."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Integration Engine** is a reusable platform capability in the **Integration** category of BusinessOS ERP Core. Orchestrates internal and external integrations with connectors, transformation, retry, and idempotency guarantees.
