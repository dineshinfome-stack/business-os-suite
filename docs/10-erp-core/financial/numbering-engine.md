...
summary: "Issues sequential, scoped, gap-controlled, and pattern-formatted numbers for documents and records."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Numbering Engine** is a reusable platform capability in the **Financial** category of BusinessOS ERP Core. Issues sequential, scoped, gap-controlled, and pattern-formatted numbers for documents and records.
