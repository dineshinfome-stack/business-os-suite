...
summary: "Provides the canonical voucher abstraction (headers, lines, states) used by every financial and inventory transaction."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "financial"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "financial"
...
The **Voucher Engine** is a reusable platform capability in the **Financial** category of BusinessOS ERP Core. Provides the canonical voucher abstraction (headers, lines, states) used by every financial and inventory transaction.
