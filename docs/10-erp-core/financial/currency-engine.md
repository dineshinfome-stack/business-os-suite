...
summary: "Manages currencies, rates, revaluation, and multi-currency conversions with historical accuracy."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Currency Engine** is a reusable platform capability in the **Financial** category of BusinessOS ERP Core. Manages currencies, rates, revaluation, and multi-currency conversions with historical accuracy.
