...
summary: "Produces parameterized, permission-aware reports from governed data sources with export-friendly outputs."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "intelligence"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "intelligence"
...
The **Reporting Engine** is a reusable platform capability in the **Intelligence** category of BusinessOS ERP Core. Produces parameterized, permission-aware reports from governed data sources with export-friendly outputs.
