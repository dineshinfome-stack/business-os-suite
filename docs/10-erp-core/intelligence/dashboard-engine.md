...
summary: "Composes and serves role-aware operational dashboards from reusable widgets and data sources."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Dashboard Engine** is a reusable platform capability in the **Intelligence** category of BusinessOS ERP Core. Composes and serves role-aware operational dashboards from reusable widgets and data sources.
