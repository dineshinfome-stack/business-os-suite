---
title: "Rules Engine"
summary: "Evaluates declarative business logic (decision tables, condition sets, expressions) as a reusable capability."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
tags: ["engine", "core", "workflow"]
depends_on:
  - "docs/canon.md"
  - "docs/02-architecture/master-architecture.md"
  - "docs/10-erp-core/README.md"
engine_category: "workflow"
...
The **Rules Engine** is a reusable platform capability in the **Workflow** category of BusinessOS ERP Core. Evaluates declarative business logic (decision tables, condition sets, expressions) as a reusable capability.
