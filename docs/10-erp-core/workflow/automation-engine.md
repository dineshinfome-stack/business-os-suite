...
summary: "Executes event-driven, rule-based automations that react to platform events and orchestrate actions."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Automation Engine** is a reusable platform capability in the **Workflow** category of BusinessOS ERP Core. Executes event-driven, rule-based automations that react to platform events and orchestrate actions.
