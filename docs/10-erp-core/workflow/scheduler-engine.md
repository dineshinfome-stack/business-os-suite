...
summary: "Schedules, dispatches, and monitors time-based and recurring work across the platform."
layer: "platform"
owner: "Platform"
status: "draft"
updated: "2026-07-05"
...
The **Scheduler Engine** is a reusable platform capability in the **Workflow** category of BusinessOS ERP Core. Schedules, dispatches, and monitors time-based and recurring work across the platform.
