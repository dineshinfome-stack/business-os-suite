...
| SPR-MOD-011-002 — Preventive Visit Scheduling | Delivery | Draft | Authoritative | `docs/30-sprint-prds/amc/SPR-MOD-011-002-preventive-visit-scheduling.md` |
| SPR-MOD-011-003 — Contract Billing & Renewals | Delivery | Draft | Authoritative | `docs/30-sprint-prds/amc/SPR-MOD-011-003-contract-billing-and-renewals.md` |
...
| SPR-MOD-012-004 — SLA & Escalation | Delivery | Draft | Authoritative | `docs/30-sprint-prds/field-service/SPR-MOD-012-004-sla-and-escalation.md` |
...
| MOD003_CROSS_PLATFORM_CERTIFICATION_20260719T210000Z | Certification Report | Active | Authoritative | `docs/50-audit-reports/MOD003_CROSS_PLATFORM_CERTIFICATION_20260719T210000Z.md` |
| MOD003_CROSS_PLATFORM_CERTIFICATION_VERIFICATION_20260719T210500Z | Audit Report | Active | Authoritative | `docs/50-audit-reports/MOD003_CROSS_PLATFORM_CERTIFICATION_VERIFICATION_20260719T210500Z.md` |
...
| MOD008_PAYROLL_BASELINE_v1 | Module Baseline | Frozen | Authoritative | `docs/40-module-baselines/MOD008_PAYROLL_BASELINE_v1.md` |
...
| MOD013_ASSETS_BASELINE_v1 | Module Baseline | Frozen | Authoritative | `docs/40-module-baselines/MOD013_ASSETS_BASELINE_v1.md` |
| MOD014_FLEET_BASELINE_v1 | Module Baseline | Frozen | Authoritative | `docs/40-module-baselines/MOD014_FLEET_BASELINE_v1.md` |
...
| SPR-MOD-009-004 — Sub-contracting | Delivery | Draft | Authoritative | `docs/30-sprint-prds/manufacturing/SPR-MOD-009-004-sub-contracting.md` |
...
| SPR-MOD-010-005 — Projects Analytics & Compliance | Delivery | Draft | Authoritative | `docs/30-sprint-prds/projects/SPR-MOD-010-005-projects-analytics-and-compliance.md` |
...
| MOB Specifications — Family Index (46-) | Solution Design | Active | Reference | `docs/46-solution-design/mobile/README.md` |
| MOB-003 — Sales Mobile Solution Design Specification | Solution Design | Active | Authoritative | `docs/46-solution-design/mobile/sales/MOB-003_SOLUTION_DESIGN.md` |
