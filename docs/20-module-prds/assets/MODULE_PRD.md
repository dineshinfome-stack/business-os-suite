---
title: "MOD-013 — Assets Module PRD"
summary: "Authoritative business specification for the Assets bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Operations"
status: "approved"
updated: "2026-07-16"
...
module: "Assets"
domain: "Operations"
bounded_context: "Fixed Asset Management"
governance_specification: "v1.0"
template_standard: "v1.3"
lifecycle_state: "Active"
sprint_authority: "docs/30-sprint-prds/assets/MOD-013_SPRINT_PLAN.md"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-007", "ENG-008", "ENG-014", "ENG-021", "ENG-024", "ENG-010", "ENG-011", "ENG-015", "ENG-016", "ENG-017", "ENG-025", "ENG-026", "ENG-027"]
related_adrs: ["ADR-011", "ADR-032"]
related_modules: ["MOD-001", "MOD-002", "MOD-017"]
referenced_by: []
derived_from: "docs/20-module-prds/assets/MODULE_PRD.md (pre-freeze, updated 2026-07-05)"
tags: ["module", "prd"]
document_type: "Module PRD"
---

# MOD-013 — Assets Module PRD

> **Authoritative business specification** for the **Assets (MOD-013)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Asset register, capitalization, depreciation, maintenance, and disposal for fixed assets.

**Business Objectives.**

- Provide the authoritative business surface for the Fixed Asset Management bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Fixed Asset Management bounded context.
...
**Ownership.** All entities above are owned by **Assets (MOD-013)** unless explicitly declared as shared in section 13.
...
- Depreciation methods per class
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Assets (MOD-013)**.
