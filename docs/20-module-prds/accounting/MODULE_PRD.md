---
title: "MOD-002 — Accounting Module PRD"
summary: "Authoritative business specification for the Accounting bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Finance"
status: "approved"
updated: "2026-07-05"
...
module: "Accounting"
domain: "Finance"
bounded_context: "General Ledger and Sub-ledgers"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-007", "ENG-008", "ENG-011", "ENG-015", "ENG-016", "ENG-017", "ENG-018", "ENG-019", "ENG-021", "ENG-024", "ENG-026", "ENG-027", "ENG-010", "ENG-012", "ENG-020", "ENG-022", "ENG-023", "ENG-025", "ENG-028"]
related_adrs: ["ADR-011", "ADR-014", "ADR-032"]
related_modules: ["MOD-001", "MOD-003", "MOD-004", "MOD-008", "MOD-015", "MOD-017"]
referenced_by: []
tags: ["module", "prd"]
document_type: "Module PRD"
---

# MOD-002 — Accounting Module PRD

> **Authoritative business specification** for the **Accounting (MOD-002)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** General ledger, journals, banking, receivables, payables, and period-close for every legal entity.

**Business Objectives.**

- Provide the authoritative business surface for the General Ledger and Sub-ledgers bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the General Ledger and Sub-ledgers bounded context.
...
- Journal capture and posting
- Invoice-to-payment (AP)
- Invoice-to-cash (AR)
- Bank reconciliation
- Tax computation and filing
- Month/quarter/year close
...
**Ownership.** All entities above are owned by **Accounting (MOD-002)** unless explicitly declared as shared in section 13.
...
- Reversal creates a new voucher; original is never mutated.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Accounting (MOD-002)**.
