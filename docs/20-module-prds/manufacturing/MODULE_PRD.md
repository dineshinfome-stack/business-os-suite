---
title: "MOD-009 — Manufacturing Module PRD"
summary: "Authoritative business specification for the Manufacturing bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Operations"
status: "approved"
updated: "2026-07-15"
...
> **Authoritative business specification** for the **Manufacturing (MOD-009)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** BOMs, routings, work orders, production planning, and shopfloor execution for make-to-stock and make-to-order.

**Business Objectives.**

- Provide the authoritative business surface for the Production and Planning bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Production and Planning bounded context.
...
- Sub-contract dispatch and return
- In-process quality
...
**Ownership.** All entities above are owned by **Manufacturing (MOD-009)** unless explicitly declared as shared in section 13.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Manufacturing (MOD-009)**.
