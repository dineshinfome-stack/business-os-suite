---
title: "MOD-016 — Service Desk Module PRD"
summary: "Authoritative business specification for the Service Desk bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Service"
status: "approved"
updated: "2026-07-05"
...
module: "Service Desk"
domain: "Service"
bounded_context: "Customer and Internal Support"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-007", "ENG-008", "ENG-010", "ENG-011", "ENG-012", "ENG-013", "ENG-020", "ENG-021", "ENG-022", "ENG-024", "ENG-025", "ENG-023", "ENG-027", "ENG-028"]
...
# MOD-016 — Service Desk Module PRD

> **Authoritative business specification** for the **Service Desk (MOD-016)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Ticketing, SLAs, escalations, and knowledge management for internal and external support.

**Business Objectives.**

- Provide the authoritative business surface for the Customer and Internal Support bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Customer and Internal Support bounded context.
...
**Ownership.** All entities above are owned by **Service Desk (MOD-016)** unless explicitly declared as shared in section 13.
...
- SLA countdowns pause during customer-waiting states as configured.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Service Desk (MOD-016)**.
