---
title: "MOD-010 — Projects Module PRD"
summary: "Authoritative business specification for the Projects bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Delivery"
status: "approved"
updated: "2026-07-15"
...
module: "Projects"
domain: "Delivery"
bounded_context: "Project Delivery"
governance_specification: "v1.0"
template_standard: "v1.3"
lifecycle_state: "Active"
sprint_authority: "docs/30-sprint-prds/projects/MOD-010_SPRINT_PLAN.md"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-007", "ENG-010", "ENG-011", "ENG-014", "ENG-017", "ENG-021", "ENG-022", "ENG-024", "ENG-008", "ENG-012", "ENG-015", "ENG-018", "ENG-023", "ENG-025", "ENG-026", "ENG-027"]
related_adrs: ["ADR-011", "ADR-032"]
related_modules: ["MOD-001", "MOD-007", "MOD-002", "MOD-008", "MOD-017"]
referenced_by: []
derived_from: "docs/20-module-prds/projects/MODULE_PRD.md (pre-freeze, updated 2026-07-05)"
tags: ["module", "prd"]
document_type: "Module PRD"
---

# MOD-010 — Projects Module PRD

> **Authoritative business specification** for the **Projects (MOD-010)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Projects, tasks, timesheets, milestones, and project billing for services and delivery organizations.

**Business Objectives.**

- Provide the authoritative business surface for the Project Delivery bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Project Delivery bounded context.
...
**Ownership.** All entities above are owned by **Projects (MOD-010)** unless explicitly declared as shared in section 13.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Projects (MOD-010)**.
