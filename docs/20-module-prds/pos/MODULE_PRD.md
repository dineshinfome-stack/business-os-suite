---
title: "MOD-015 — POS Module PRD"
summary: "Authoritative business specification for the POS bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Revenue"
status: "approved"
updated: "2026-07-16"
...
# MOD-015 — POS Module PRD

> **Authoritative business specification** for the **POS (MOD-015)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Retail counter operations: cart, payments, receipts, offers, and day-close integrated with inventory and finance.

**Business Objectives.**

- Provide the authoritative business surface for the Point of Sale bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Point of Sale bounded context.
...
**Ownership.** All entities above are owned by **POS (MOD-015)** unless explicitly declared as shared in section 13.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **POS (MOD-015)**.
