---
title: "MOD-017 — Analytics Module PRD"
summary: "Authoritative business specification for the Analytics bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Insights"
status: "approved"
updated: "2026-07-05"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-020", "ENG-021", "ENG-022", "ENG-024", "ENG-027", "ENG-014", "ENG-023", "ENG-025", "ENG-026", "ENG-028"]
related_adrs: ["ADR-011", "ADR-032"]
related_modules: ["MOD-001", "MOD-002", "MOD-003", "MOD-004", "MOD-005", "MOD-006", "MOD-007", "MOD-008", "MOD-009", "MOD-010", "MOD-011", "MOD-012", "MOD-013", "MOD-014", "MOD-015", "MOD-016", "MOD-018"]
referenced_by: []
tags: ["module", "prd"]
document_type: "Module PRD"
---

# MOD-017 — Analytics Module PRD

> **Authoritative business specification** for the **Analytics (MOD-017)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Curated data marts, KPIs, dashboards, and scheduled analytics across the enterprise.

**Business Objectives.**

- Provide the authoritative business surface for the Business Analytics bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Business Analytics bounded context.
- Emit the events in section 8 for downstream consumers.
- Respect the module dependency graph declared in section 13.

**Business Ownership.**

- Primary owner: **Insights**.
...
- All module users (as report consumers)
...
**Ownership.** All entities above are owned by **Analytics (MOD-017)** unless explicitly declared as shared in section 13.
...
- KPI definitions must be published from a single, versioned KPI catalog.
- Sensitive KPIs respect data classification and row-level access.
- Dashboards must declare their data-freshness expectation.
...
- All module domain events (as inputs to marts)

**External Systems (business categories only).**

- External BI (via export)
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Analytics (MOD-017)**.
