---
title: "MOD-014 — Fleet Module PRD"
summary: "Authoritative business specification for the Fleet bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "Operations"
status: "approved"
updated: "2026-07-05"
...
module: "Fleet"
domain: "Operations"
bounded_context: "Fleet and Vehicle Management"
...
related_engines: ["ENG-001", "ENG-002", "ENG-003", "ENG-004", "ENG-005", "ENG-006", "ENG-007", "ENG-008", "ENG-014", "ENG-021", "ENG-024", "ENG-025", "ENG-013", "ENG-020", "ENG-022", "ENG-023", "ENG-027"]
related_adrs: ["ADR-011", "ADR-032"]
related_modules: ["MOD-001", "MOD-002", "MOD-012", "MOD-017"]
referenced_by: []
tags: ["module", "prd"]
document_type: "Module PRD"
---

# MOD-014 — Fleet Module PRD

> **Authoritative business specification** for the **Fleet (MOD-014)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Vehicles, drivers, trips, fuel, maintenance, and compliance for owned or hired fleets.

**Business Objectives.**

- Provide the authoritative business surface for the Fleet and Vehicle Management bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Fleet and Vehicle Management bounded context.
...
**Ownership.** All entities above are owned by **Fleet (MOD-014)** unless explicitly declared as shared in section 13.
...
- A trip cannot be closed without odometer readings.
- Vehicles with expired critical compliance cannot be assigned to trips.
- Fuel entries reconcile against telematics where available.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **Fleet (MOD-014)**.
