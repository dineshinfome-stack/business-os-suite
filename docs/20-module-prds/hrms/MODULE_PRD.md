---
title: "MOD-007 — HRMS Module PRD"
summary: "Authoritative business specification for the HRMS bounded context. Consumes ERP Core Engines and Accepted ADRs; does not redefine platform behavior."
layer: "business"
owner: "People"
status: "approved"
updated: "2026-07-13"
...
> **Authoritative business specification** for the **HRMS (MOD-007)** bounded context. This document consumes — and MUST NOT redefine — Foundation, Architecture, ERP Core Engines (`ENG-NNN`), and Accepted ADRs (`ADR-NNN`). Cross-module references use `MOD-NNN`. On any conflict with an upstream authoritative document, the upstream wins and this PRD is corrected in the same change.

## 1. Module Overview

**Purpose.** Employee master, org structure, attendance, leave, performance, and lifecycle for the workforce.

**Business Objectives.**

- Provide the authoritative business surface for the Human Capital bounded context.
...
- Own the master data and transactions listed in sections 5–6 for the Human Capital bounded context.
...
**Ownership.** All entities above are owned by **HRMS (MOD-007)** unless explicitly declared as shared in section 13.
...
No engine behavior may be redefined. Consumption declared here is authoritative for **HRMS (MOD-007)**.
