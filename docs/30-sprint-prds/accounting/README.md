...
| --- | --- | --- | --- | --- | --- |
| SPR-MOD-002-001 | Sprint 1 | [Accounting Foundation](./SPR-MOD-002-001-accounting-foundation.md) | Medium | Done | — |
| SPR-MOD-002-002 | Sprint 2 | [Voucher Framework](./SPR-MOD-002-002-voucher-framework.md) | Large | Done | SPR-MOD-002-001 |
| SPR-MOD-002-003 | Sprint 3 | [Journal & Ledger Posting](./SPR-MOD-002-003-journal-ledger-posting.md) | Large | Done | SPR-MOD-002-002 |
| SPR-MOD-002-004 | Sprint 4 | [Financial Statements](./SPR-MOD-002-004-financial-statements.md) | Large | Done | SPR-MOD-002-003 |
| SPR-MOD-002-005 | Sprint 5 | [Taxation & Compliance Foundation](./SPR-MOD-002-005-taxation-compliance-foundation.md) | Medium | Done | SPR-MOD-002-001 through SPR-MOD-002-004 |
| SPR-MOD-002-006 | Sprint 6 | [Period Close & Audit](./SPR-MOD-002-006-period-close-audit.md) | Medium | Done | SPR-MOD-002-001 through SPR-MOD-002-005 |

The MOD-002 Accounting module has been frozen at Stage 3 as [`MOD002_ACCOUNTING_BASELINE_v1`](../../40-module-baselines/MOD002_ACCOUNTING_BASELINE_v1.md). Downstream modules SHOULD reference the baseline rather than individual Sprint PRDs unless sprint-level traceability is explicitly required.
