...
| 7 | Module PRDs (Pass 7+) | `docs/04-domains/` |
| 8 | Sprint PRDs (Pass 8+) | to be introduced |
...
| — | Cross-cutting derived indexes | `docs/` root (Repository Map, Document Index, Document Traceability, Ownership Matrix, Glossary Index, Engine Usage Matrix, ADR Impact Matrix, Module Catalog) |
