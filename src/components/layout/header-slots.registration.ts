...
// Start area — brand + primary navigator control.
...
registerHeaderSlot({ id: "favorites", area: "end", order: 20, component: FavoritesPopover });
registerHeaderSlot({ id: "recent", area: "end", order: 30, component: RecentPopover });
